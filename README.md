...
## Обновление данных
- Положите/перезапишите XLSX-файлы в корне проекта:
  - либо отдельные файлы `HW01 ... .xlsx`, `HW02 ... .xlsx`, и т.д.
  - либо один общий Excel-файл с листами вида `ДЗ 01`, `ДЗ 02`, ... или `HW01`, `HW02`, ...
...
- Поддерживаются два формата источника:
  - имя файла содержит `HW` и номер, например: `HW01 на 2025.12.06 13 30.xlsx`, `hw7.xlsx`
  - имя файла произвольное, но внутри есть листы `ДЗ 01`, `ДЗ 02`, ... или `HW01`, `HW02`, ...
- Если есть несколько файлов с одним номером, берется самый свежий по дате изменения
- Файлы без `HW` в названии учитываются, если в них найдены листы с номерами домашних работ
